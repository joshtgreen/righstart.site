      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="hidden lg:flex items-center gap-4 lg:gap-8" role="region" aria-label="Testimonials">
          ...
          <button
            ...
            className="flex-shrink-0 w-11 h-11 rounded-full border border-[#e5e2dc] bg-white hover:bg-[#edebe5] transition-colors flex items-center justify-center text-[#1a2744]"
          >
