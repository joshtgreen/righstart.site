          ...
          <div className="bg-[var(--navy)] rounded-2xl p-8 lg:p-10">
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-[var(--teal)]/25 flex items-center justify-center text-[var(--teal-light)]" aria-hidden="true">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-white text-sm font-medium hover:text-[var(--teal-light)] transition-colors"
                  >
                    josh@rightstart.co
                  </a>
                </div>
